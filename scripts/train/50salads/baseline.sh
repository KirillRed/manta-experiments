#!/usr/bin/env bash
OPTS="--model_dir=/data1/kredensk/anticipation/manta/normal_train/50salads/checkpoints \
      --results_dir=/data1/kredensk/anticipation/manta/normal_train/50salads/checkpoints \
