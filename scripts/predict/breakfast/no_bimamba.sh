#!/usr/bin/env bash
OPTS="--model_dir=/data1/kredensk/anticipation/manta/train_checkpoints/no_bimamba/breakfast/checkpoints \
      --results_dir=/data1/kredensk/anticipation/manta/train_checkpoints/no_bimamba/breakfast/checkpoints \
