#!/usr/bin/env bash
OPTS="--model_dir=/data1/kredensk/anticipation/manta/baseline/bz4epochs90/50salads/checkpoints \
      --results_dir=/data1/kredensk/anticipation/manta/baseline/bz4epochs90/50salads/checkpoints \
