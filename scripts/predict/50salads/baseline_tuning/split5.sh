#!/usr/bin/env bash
OPTS="--model_dir=/data1/kredensk/anticipation/manta/baseline/split5/50salads/checkpoints \
      --results_dir=/data1/kredensk/anticipation/manta/baseline/split5/50salads/checkpoints \
      --mapping_file=/data1/kredensk/anticipation/manta/datasets/breakfast/data/50salads/mapping.txt \
      --vid_list_file_test=/data1/kredensk/anticipation/manta/datasets/breakfast/data/50salads/splits/test.split5.bundle \
      --vid_list_file=/data1/kredensk/anticipation/manta/datasets/breakfast/data/50salads/splits/train.split5.bundle \
