#!/usr/bin/env bash
OPTS="--model_dir=/data1/kredensk/anticipation/manta/baseline/split3/50salads/checkpoints \
      --results_dir=/data1/kredensk/anticipation/manta/baseline/split3/50salads/checkpoints \
