...
# runtime params
parser.add_argument('--model', type=str, default='bit-diff-pred-tcn')
...
parser.add_argument('--layer_type', default='mamba')
...
if args.ds == 'assembly': 
    ...
    actions_dict = {str(i):i for i in range(args.num_classes)} # dummy dict to match the code for BF
else:
    # mapping actions
